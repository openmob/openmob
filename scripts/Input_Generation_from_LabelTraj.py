...
GENE_MODE = 'LOAD_EXISTING'
WEEKHOLIDAY_MODE = 0
user_num = 2
OUT_PUT_FOLDER = '../assets/Input_LP/' + str(1 - WEEKHOLIDAY_MODE) + '/'   #1->weekday  2->weekend
...
if GENE_MODE == 'Re_Calculate':
    ...
    for i in tqdm(range(1)):
        ...
        current_lp_df = current_lp_df[current_lp_df['holiday'] == WEEKHOLIDAY_MODE].reset_index()  # filter holidays
        hour_state_list = []
        start_flag = False
