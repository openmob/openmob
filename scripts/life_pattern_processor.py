...
matplotlib.use('Agg')
"""
raw_gps_file: raw GPS data csv file, column name: [uid, date, index, mode_1, mode_2, unknown, unknown, unknown,
        *, *, date_time_start, date_time_end, *, *, *, *, trajectory] 17 columns, used columns is [[0, 1, 3, 4, 10, 11,
        16]]
"""
...
class LifePatternProcessor:
    ...
    def __init__(self,
                 raw_gps_folder='../sample/',
                 map_file='./gis/greater_tokyo_area_dissolve.shp',
